...
\begin{figure}[H]
  \includegraphics[width=105mm]{design_whiteboard.jpg}
...
\subsection{Övergripande designdokument}
\label{sec:design}
\subsection{Koddokumentation på gränssnittsnivå}
\subsection{Gränssnitten mellan modulerna}
