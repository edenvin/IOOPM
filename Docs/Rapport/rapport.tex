...
\begin{figure}[H]
  \includegraphics[width=105mm]{../bilder/design_whiteboard.jpg}
...
\begin{figure}[H]
  \includegraphics[width=1600px]{../bilder/chart_parts.png}
...
\begin{figure}[H]
  \includegraphics[width=1600px]{../bilder/chart_people.png}
